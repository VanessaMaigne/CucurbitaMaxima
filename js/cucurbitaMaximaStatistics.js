...
CucurbitaMaximaStatistics.prototype.getColors = function(){
...
CucurbitaMaximaStatistics.prototype.getTransition = function(){
    return 10;
};

CucurbitaMaximaStatistics.prototype.getBarChartMargin = function(){
    return {top: 10, right: 0, bottom: 75, left: 35};
};
...
/* ************** TOOLTIP *************** */
/* ************************************** */
CucurbitaMaximaStatistics.prototype.updateToolTip = function() {
    d3.selectAll("svg path, svg rect").call(this.toolTip);
    d3.selectAll("svg path, svg rect")
        .on('mouseover', this.toolTip.show)
        .on('mouseout', this.toolTip.hide);
};

CucurbitaMaximaStatistics.prototype.initToolTip = function() {
    this.toolTip = d3.tip()
        .attr('class', 'd3-tip')
        .offset([-10,0])
        .html(function (d) {
...
/** ********************* BAR ******************** **/
/****************************************************/
CucurbitaMaximaStatistics.prototype.createBar = function(chartId, chartWidth, chartHeight, dimension, group, barChartMargin) {
    var context = this;

    barChartMargin = barChartMargin || context.barChartMargin;

    dc.barChart(chartId)
        .height(chartHeight)
        .width(chartWidth)
        .transitionDuration(context.transition)
        .margins(barChartMargin)
        .dimension(dimension)
        ...
        .renderlet(function(){
            $(".axis.x text").attr( "transform", "translate(-10,20)rotate(315)" );
//        context.colors
...
//);
//    d3.select(chartId + "rect").attr("style", "fill: green");
...
/** ***************** TIME SERIE ***************** **/
/****************************************************/
CucurbitaMaximaStatistics.prototype.createTimeSerie = function(chartId, chartWidth, chartHeight, dimension, group, barChartMargin) {
    var context = this;
...
//        if(a==null || b==null) alert("Not a good choice for X axis");
...
/** ***************** AREA & RANGE *************** **/
/****************************************************/
CucurbitaMaximaStatistics.prototype.createAreaChart = function(chartId, subChartId, dateDimension, dateGroup, monthlyMoveGroup, indexAvgByMonthGroup, minDate, maxDate){
    var width = 990;
